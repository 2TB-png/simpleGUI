import simpleGUI.origen, simpleGUI.userInput
import pygame


def generate_button_grid_from_matrix(matrix, width, height, font, separator: float = 0.1) -> simpleGUI.origen.Origen:
    rows = len(matrix)
    cols = len(matrix[0])
    ...
    buttons = simpleGUI.origen.Origen(0, 0)
